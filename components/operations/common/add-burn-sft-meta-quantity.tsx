    ...
    <>
      <DialogHeader className="p-8 pb-0">
        ...
        <DialogDescription>
          ...
          given {tokenType} Token, can burn some (or all) of the quantity. If
          successful, the quantity from the argument will be decreased from the
          balance of the address for that given token.
        </DialogDescription>
      </DialogHeader>
